...
const aggregate = row('dsh-web-all', { dependencies: { '@gestaltrun/dsh-child': version, '@gestaltrun/dsh-better-sidebar': '0.19.1-gestaltrun.0' }, optionalDependencies: { '@gestaltrun/dsh-optional': version }, peerDependencies: { '@gestaltrun/dsh-peer': version, '@gestaltrun/dsh-client-ui-market': version }, peerDependenciesMeta: { '@gestaltrun/dsh-client-ui-market': { optional: true } } })
