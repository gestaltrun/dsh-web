...
describe('readProfileManifest and stripBom', () => {
  it('strips leading UTF-8 BOM from package.json and cordis.patch.yml', async () => {
    ...
    try {
      ...
      await stripProfileBundles(pkgPath, ['@gestaltrun/dsh-web-all'])
