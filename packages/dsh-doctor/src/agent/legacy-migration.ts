// Generated by scripts/sync-shared.mjs from shared/host/legacy-migration.ts. Do not edit this copy; edit the shared source and run "node scripts/sync-shared.mjs".
/**
