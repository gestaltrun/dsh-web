/**
 * Package-owned invariant companion for `@gestaltrun/dsh-client-ui-git-graph`.
 ...
 * @module @gestaltrun/dsh-client-ui-git-graph/invariant
 */
...
const PACKAGE_NAME = '@gestaltrun/dsh-client-ui-git-graph'
