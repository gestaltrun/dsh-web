...
- **一次安装**：依赖以 `aggregate.yml` 为准；清单中列出的可选行保持关闭，直到用户在插件管理中启用。Better Sidebar `0.19.1-gestaltrun.0` 提供右侧栏。
...
- **右侧面板**：右侧面板固定为 `@gestaltrun/dsh-better-sidebar`，其偏好在 [dsh-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) 自身的设置区管理。
