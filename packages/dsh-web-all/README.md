...
- **One installation**: the dependencies follow `aggregate.yml`; the listed optional rows stay disabled until enabled in plugin management. Better Sidebar `0.19.1-gestaltrun.0` provides the right sidebar.
