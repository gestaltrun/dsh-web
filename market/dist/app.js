...
(function () {
  ...
  function openDetail(kind, id) {
    ...
    if (kind === 'skin') {
      ...
      steps.appendChild(el('li', null, '运行 dsh plugin --profile web add @gestaltrun/dsh-client-ui-skin-center'))
      ...
      steps2.appendChild(el('li', null, '运行 dsh plugin --profile web add @gestaltrun/dsh-pet'))
      ...
      steps4.appendChild(el('li', null, '运行 dsh plugin --profile web add @gestaltrun/dsh-client-ui-preset-center'))
